...
public class AdministrativeUnitListDestinationsPage extends AbstractPageContainerManagedImpl implements Serializable {
					...
					if(section == null) {
						...
						administrativeUnits = __inject__(AdministrativeUnitController.class)
								.read(new Properties().setFilters(new FilterDto().addField(AdministrativeUnit.FIELD_SECTION, CollectionHelper.listOf(section.getCode())))
										.setFields(AdministrativeUnit.FIELD_CODE+","+AdministrativeUnit.FIELD_NAME+","+AdministrativeUnit.FIELD_DESTINATIONS)
	...
	protected String __getWindowTitleValue__() {
		return "Correspondance des unités administratives aux destinations du SIGBUD";
	}
