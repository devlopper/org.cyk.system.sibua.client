...
public class AdministrativeUnitListActivitiesPage extends AbstractPageContainerManagedImpl implements Serializable {
	...
	protected String __getWindowTitleValue__() {
		return "Correspondance des unités administratives aux activités";
	}
