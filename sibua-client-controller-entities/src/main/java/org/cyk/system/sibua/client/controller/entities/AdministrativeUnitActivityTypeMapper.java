...
@Mapper
public abstract class AdministrativeUnitActivityTypeMapper extends AbstractMapperSourceDestinationImpl<AdministrativeUnitActivityType, AdministrativeUnitActivityTypeDto> {
